...
class StoreAssetRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'serial_number' => ['nullable', 'string', 'max:100', Rule::unique('assets', 'serial_number')->where('tenant_id', Tenant::current()?->id)],
            ...
            'asset_cluster_id' => ['required', 'exists:asset_clusters,id'],
            'asset_sub_cluster_id' => ['required', 'exists:asset_sub_clusters,id'],
        ];
    }
}
