# Graph Report - opti-asset  (2026-09-19)

## Corpus Check
- 845 files · ~1,109,975 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 12644 nodes · 27602 edges · 590 communities (493 shown, 45 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 665 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6f61a453`
...
- .qwen/skills/impeccable/scripts/detector/shared/color.mjs
...
## Communities (590 total, 45 thin omitted)

### Community 0 - "button.tsx"
Cohesion: 0.03
Nodes (141): DeleteUser(), InputError(), Props, Props, Props, Button(), Dialog(), DialogClose() (+133 more)

### Community 1 - "Illuminate\Http\RedirectResponse"
Cohesion: 0.03
Nodes (44): AssetStatus, AssetClassificationController, AssetController, AssetDisposalController, AssetHistoryController, AssetTransferController, AuditLogController, Controller (+36 more)
...
Cohesion: 0.04
Nodes (30): ImportClassificationsAction, AssetCategoryController, ActivityLog, AssetCategory, AssetCluster, AssetGroup, AssetHistory, AssetSubCluster (+22 more)
...
### Community 10 - "User"
Cohesion: 0.04
Nodes (41): SyncUserRolesFromEmployeeAction, User, RolePermissionSeeder, Illuminate\Auth\Events\Verified, Illuminate\Auth\Notifications\ResetPassword, Illuminate\Auth\Notifications\VerifyEmail, Illuminate\Database\Eloquent\Attributes\Fillable, Illuminate\Database\Eloquent\Attributes\Hidden (+33 more)

### Community 11 - "Illuminate\Foundation\Http\FormRequest"
Cohesion: 0.03
Nodes (25): AssetTransferStatus, AssignEmployeeRolesRequest, ImportAssetsRequest, TwoFactorAuthenticationRequest, StoreAssetDisposalRequest, StoreAssetRequest, StoreCapitalizationThresholdRequest, StoreCategoryRequest (+17 more)

### Community 12 - "PasswordValidationRules"
Cohesion: 0.09
Nodes (12): CreateTenantAction, CreateNewUser, ResetUserPassword, PasswordValidationRules, ProfileValidationRules, PasswordUpdateRequest, ProfileUpdateRequest, Illuminate\Contracts\Validation\ValidationRule (+4 more)

### Community 13 - "Asset"
Cohesion: 0.02
Nodes (13): Asset, AssetBookValue, CapitalizationThreshold, AssetObserver, AssetTypeAssigner, DepreciationCalculator, Carbon, Illuminate\Database\Eloquent\Relations\BelongsTo (+5 more)

### Community 14 - "two-factor-setup-modal.tsx"
Cohesion: 0.05
Nodes (53): AlertError(), BookValueSnapshot, Heading(), ManagePasskeys(), Props, ManageTwoFactor(), Props, PasskeyItem() (+45 more)

### Community 15 - "cn"
Cohesion: 0.04
Nodes (88): AppLogoIcon(), Props, Props, NavFooter(), NavMain(), TenantSwitcher(), Breadcrumb(), BreadcrumbEllipsis() (+80 more)
...
Cohesion: 0.04
Nodes (97): appendAutonomyCounterDirective(), appendDetectorFallback(), appendImageGenDirective(), appendImageToolsDirective(), appendStalenessDirective(), appendSubagentAuthorizationDirective(), appendSurfaceBriefContext(), automaticHookMode() (+89 more)
...
### Community 19 - "tenant-switcher.tsx"
Cohesion: 0.11
...
Cohesion: 0.08
Nodes (34): Asset, AssetCard(), CONDITION_ACCENTS, conditionAccent(), formatDate(), BookValueHistory(), ASSET_STATUSES, assetStatusChip() (+26 more)

### Community 21 - ".agents/skills/impeccable/scripts/detector/engines/regex/detect-text.mjs"
Cohesion: 0.07
Nodes (39): blankCssComments(), BLOCK_BRACE_PREFIX_KEYWORDS, CSS_IN_JS_EXTENSIONS, extFromFilePath(), extractCSSinJS(), extractStyleBlocks(), findCSSinJSTemplates(), findQuotedStringEnd() (+31 more)
...
Cohesion: 0.07
Nodes (50): confirm(), detectCli(), dim(), fileUrlToLocalPath(), formatAdvisorySection(), formatFindings(), formatFindingsBody(), formatFindingSummary() (+42 more)
...
Cohesion: 0.11
Nodes (24): AppearanceToggleTab(), Toaster(), TooltipProvider(), Appearance, applyTheme(), getStoredAppearance(), handleSystemThemeChange(), initializeTheme() (+16 more)
...
Cohesion: 0.06
Nodes (51): ACK_EXTS, ADVISORY_RULES, applyConfigSource(), applyDetectorConfigSource(), applyPatchText(), canonicalPathCache, clampByte(), cloneDefaultConfig() (+43 more)
...
Cohesion: 0.04
Nodes (13): GenerateAssetImportTemplateAction, RecordAssetHistoryAction, Response, AssetTransfer, Location, AssetTransferFactory, OpenSpout\Common\Entity\Style\CellAlignment, OpenSpout\Common\Entity\Style\Color (+5 more)

### Community 41 - "utils.ts"
Cohesion: 0.05
Nodes (73): CHILD_LABEL, ClassificationDetailPanel(), DetailProps, ItemRouteFn, LEVEL_ORDER, UPDATE, ClassificationForm(), FormProps (+65 more)
...
Cohesion: 0.06
Nodes (67): confirm(), detectCli(), dim(), fileUrlToLocalPath(), formatAdvisorySection(), formatFindings(), formatFindingsBody(), formatFindingSummary() (+59 more)

### Community 57 - ".agents/skills/impeccable/scripts/hook-lib.mjs"
Cohesion: 0.05
Nodes (56): ACK_EXTS, ADVISORY_RULES, ALLOWED_EXTS, applyConfigSource(), applyDetectorConfigSource(), applyPatchText(), canonicalPath(), canonicalPathCache (+48 more)
...
Cohesion: 0.07
Nodes (57): CRITIQUE_DIR, firstExisting(), getDesignSidecarCandidates(), getDesignSidecarPath(), getImpeccableDir(), getLegacyLiveConfigPath(), getLegacyLiveServerPath(), getLegacyLiveSessionsDir() (+49 more)
...
Cohesion: 0.05
Nodes (55): AppContent(), Props, AppHeader(), AppShell(), Props, AppSidebar(), AppSidebarHeader(), Props (+47 more)
...
### Community 78 - "AssetDisposal"
Cohesion: 0.09
Nodes (6): AssetDisposal, AssetDisposalSeeder, DatabaseSeeder, Illuminate\Database\Console\Seeds\WithoutModelEvents, Illuminate\Database\Seeder, AssetDisposalTest
...
Cohesion: 0.12
Nodes (32): getLegacyLiveSessionsDir(), safeSessionId(), collectManualApplyFiles(), manualApplyReplyCommand(), manualApplyResumeHint(), mountFailureAction(), parseArgs(), renderSummary() (+24 more)
...
### Community 84 - ".qwen/skills/impeccable/scripts/detector/engines/browser/detect-url.mjs"
Cohesion: 0.19
...
### Community 86 - ".agents/skills/impeccable/scripts/lib/impeccable-paths.mjs"
Cohesion: 0.11
Nodes (31): CRITIQUE_DIR, firstExisting(), getDesignSidecarCandidates(), getDesignSidecarPath(), getImpeccableDir(), getLegacyLiveServerPath(), getLiveAnnotationsDir(), getLiveConfigPath() (+23 more)
...
Cohesion: 0.15
Nodes (26): appendDesignSystemNote(), bumpEditCount(), clampGroupedToBudget(), dedupeAgainstCache(), depthIsSet(), designSystemOptions(), ensureFile(), ensureSession() (+18 more)
...
Cohesion: 0.14
Nodes (25): bumpEditCount(), coLocatedStylesheets(), dedupeAgainstCache(), depthIsSet(), ensureFile(), ensureSession(), expandScanTargets(), findingCacheKey() (+17 more)
...
Cohesion: 0.16
Nodes (6): AppServiceProvider, FortifyServiceProvider, Illuminate\Cache\RateLimiting\Limit, Illuminate\Support\Facades\RateLimiter, Illuminate\Support\ServiceProvider, Laravel\Fortify\Fortify
...
### Community 100 - ".agents/skills/impeccable/scripts/live-inject.mjs"
Cohesion: 0.13
Nodes (23): getLegacyLiveConfigPath(), resolveLiveConfigPath(), describeInjectArtifacts(), frameworkIgnorePatterns(), resolveFramework(), applyNuxtLiveAdapter(), buildNuxtPlugin(), detectNuxtProject() (+15 more)

### Community 101 - "resolveProjectRoot"
Cohesion: 0.26
Nodes (14): resolveProjectRoot(), getLegacyLiveAnnotationsDir(), getSurfaceBriefDir(), listSurfaceBriefs(), normalizeSurfaceTarget(), parseSurfaceBrief(), resolveSurfaceBrief(), SURFACE_BRIEF_VERSION (+6 more)
...
### Community 108 - ".agents/skills/impeccable/scripts/lib/staleness-deep.mjs"
Cohesion: 0.17
...
Cohesion: 0.05
Nodes (19): SyncDepartments, SyncEmployees, SyncTenants, HandleInertiaRequests, Department, Employee, Tenant, Command (+11 more)
...
Cohesion: 0.12
Nodes (27): extractPlatform(), hasVisualImplementation(), loadContext(), cli(), COMMON_DEV_PORTS, devServerSignals(), gatherSignals(), gitSignals() (+19 more)
...
### Community 165 - "Illuminate\Database\Eloquent\Factories\Factory"
Cohesion: 0.06
Nodes (16): ActivityLogFactory, AssetDisposalFactory, static, AssetFactory, AssetGroupFactory, AssetHistoryFactory, CategoryFactory, DepartmentFactory (+8 more)

### Community 166 - "asset-form.tsx"
Cohesion: 0.09
Nodes (26): ASSET_OPTIONS, AssetForm(), AssetFormProps, AssetInitial, AssetOption, CONDITION_OPTIONS, ALLOWED_DOCS, ALLOWED_PHOTOS (+18 more)
...
### Community 169 - "Item"
Cohesion: 0.07
Nodes (4): Item, AuditLogTest, BrowseTest, ItemTest
...
Cohesion: 0.05
Nodes (41): AGENTS.md — Opti-Asset (Laravel + Inertia + React), APIs & Eloquent Resources, Application Structure & Architecture, Architecture, Artisan, Aturan, Commands, Conventions (+33 more)
...
Cohesion: 0.10
Nodes (44): checkColors(), checkCreamPalette(), checkElementAIPaletteDOM(), checkElementColors(), checkElementColorsDOM(), checkElementGlowDOM(), checkElementHoverContrast(), checkElementIconTile() (+36 more)
...
### Community 176 - "syncEditBadgeHitProxies"
Cohesion: 0.27
Nodes (10): bindEditBadgeProxy(), editBadgeProxyTargets(), initEditBadge(), initEditBadgeHitProxies(), positionEditBadge(), proxyMouseEvent(), setImportantStyle(), styleEditBadgeProxy() (+2 more)

### Community 178 - "filterFindings"
Cohesion: 0.14
Nodes (22): parseIgnoreValueArgs(), requireGlob(), clampGroupedToBudget(), clampToBudget(), cleanIgnoreValueDisplay(), directiveFooter(), extractFindingIgnoreValue(), extractFindingIgnoreValueRaw() (+14 more)
...
### Community 195 - ".qwen/skills/impeccable/scripts/live/frameworks/journal.mjs"
Cohesion: 0.27
...
### Community 237 - "Category"
Cohesion: 0.10
Nodes (4): ClassificationLevel, CategoryController, Category, CategoryTest

### Community 244 - ".agents/skills/impeccable/scripts/critique-storage.mjs"
Cohesion: 0.30
...
### Community 249 - ".agents/skills/impeccable/scripts/lib/staleness-notice.mjs"
Cohesion: 0.38
...
### Community 255 - ".agents/skills/impeccable/scripts/detector/engines/static-html/detect-html.mjs"
Cohesion: 0.12
Nodes (18): checkStaticPageTypography(), STATIC_ELEMENT_RULES, checkElementGlow(), checkPageLayout(), checkPageQualityDOM(), checkPageQualityFromDoc(), isCardLike(), parseRadiusToPx() (+10 more)
...
### Community 267 - ".qwen/skills/impeccable/scripts/live/source-lock.mjs"
Cohesion: 0.50
...
Cohesion: 0.22
Nodes (8): Colors, Effects, Interaction States, Layout, Motion Guidelines, Overview, Typography, Use Case

### Community 371 - "filterFindings"
Cohesion: 0.18
...
### Community 583 - ".qwen/skills/impeccable/scripts/detector/shared/color.mjs"
Cohesion: 0.21
...
Cohesion: 0.33
Nodes (6): Auth & Permissions (rebuilt 2026-09-09), Current State, Design System, Persistent Gotchas, Stack, Testing Conventions

### Community 588 - "expandScanTargets"
Cohesion: 0.53
...
## Knowledge Gaps
- **3899 isolated node(s):** `idea-refine.sh script`, `here`, `API_BASE`, `API_TIMEOUT_MS`, `localStates` (+3894 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 4594 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
...
- **Why does `Asset` connect `Asset` to `Illuminate\Http\RedirectResponse`, `AssetGroup`, `Illuminate\Database\Eloquent\Factories\Factory`, `Location`, `Item`, `User`, `Illuminate\Foundation\Http\FormRequest`, `AssetDisposal`, `ImportAssetsAction`, `AppServiceProvider`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `button.tsx`, `reports/Index.tsx`, `asset-form.tsx`, `dashboard.tsx`, `dropdown-menu.tsx`, `utils.ts`, `two-factor-setup-modal.tsx`, `tenant-switcher.tsx`, `assets/Show.tsx`, `select.tsx`, `chart.tsx`, `use-appearance.tsx`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
...
- **What connects `idea-refine.sh script`, `here`, `API_BASE` to the rest of the system?**
  _3899 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `button.tsx` be split into smaller, more focused modules?**
  _Cohesion score 0.031001642036124794 - nodes in this community are weakly interconnected._