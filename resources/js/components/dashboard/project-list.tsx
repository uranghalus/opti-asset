...
const projects = [
    { name: 'Pengadaan Laptop 2026', type: 'Pengadaan', progress: 75, color: '#006FCF' },
    { name: 'Migrasi Server', type: 'Infrastruktur', progress: 60, color: '#00875A' },
    { name: 'Renovasi Kantor', type: 'Fasilitas', progress: 90, color: '#BF9B30' },
                ...
                {projects.map((p) => (
                    ...
                    >
                        <div className="flex items-start justify-between">
                            <div>
                                <p className="text-sm font-medium text-[#1A1A1A] dark:text-white">{p.name}</p>
                                <p className="mt-0.5 text-[11px] text-[#86888C]">{p.type}</p>
                            </div>
